...
@usuario_router.get("/{field}/sum",
    ...
    operation_id="usuario_sum_field",
    summary="Suma un campo numérico específico en la tabla usuario",
    responses={
        200: {
...
async def usuario_sum_field(
    ...
    GET /usuario/edad/sum
    
    # Sumar campo con filtros
    GET /usuario/salario/sum?nombre=Juan
    ```
    """
    result = await api.usuario.sum(
        agg_fields=[field],
        nombre=nombre,
        in_nombre=in_nombre,
        correo=correo,
...
@usuario_router.get("/{field}/mean",
    response_model=APIResponse[float],
    operation_id="usuario_mean_field",
    summary="Calcula la media de un campo numérico específico en la tabla usuario",
    responses={
        200: {
...
async def usuario_mean_field(
    ...
    GET /usuario/edad/mean
    
    # Calcular media de campo con filtros
    GET /usuario/salario/mean?departamento=ventas
    ```
    """
    result = await api.usuario.mean(
        agg_fields=[field],
        nombre=nombre,
        in_nombre=in_nombre,
        correo=correo,
...
@usuario_router.get("/{field}/max",
    ...
    operation_id="usuario_max_field",
    summary="Encuentra el valor máximo de un campo específico en la tabla usuario",
    responses={
        200: {
...
async def usuario_max_field(
    ...
    GET /usuario/salario/max
    
    # Encontrar fecha más reciente con filtros
    GET /usuario/fecha_creacion/max?activo=true
    ```
    """
    result = await api.usuario.max(
        agg_fields=[field],
        nombre=nombre,
        in_nombre=in_nombre,
        correo=correo,
...
@usuario_router.get("/{field}/min",
    response_model=APIResponse[Optional[Union[int, float, str]]],
    operation_id="usuario_min_field",
    summary="Encuentra el valor mínimo de un campo específico en la tabla usuario",
    responses={
        200: {
...
async def usuario_min_field(
    ...
    GET /usuario/edad/min
    
    # Encontrar fecha más antigua con filtros
    GET /usuario/fecha_registro/min?ciudad=Madrid
    ```
    """
    result = await api.usuario.min(
        agg_fields=[field],
        nombre=nombre,
        in_nombre=in_nombre,
        correo=correo,
...
@usuario_router.post("/agg",
    response_model=APIResponse[Dict[str, Optional[Union[int, float, str]]]],
    operation_id="usuario_aggregate",
    summary="Realiza múltiples agregaciones en la tabla usuario",
    responses={
        200: {
...
async def usuario_aggregate(
    ...
    """
    ## Resumen
    Realiza múltiples operaciones de agregación en una sola consulta sobre la tabla usuario.
...
async def usuario_find(
    id: int = Path(..., description="Campo id de la tabla usuario", gt=0),
    includes: List[str] = Query(None, description="Lista de relaciones a incluir en la respuesta para obtener datos relacionados. Especifica los nombres de las relaciones que deseas expandir"),
